...
public class AccelerometerPlayActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap icon = BitmapFactory.decodeResource(getResources(),
                R.drawable.ball);
        AppHelper.saveImage(this, icon, "image", "jpg");
        mSimulationView.postDelayed(new Runnable() {
            @Override
            public void run() {
                Bitmap saved = AppHelper.getImageBitmap(AccelerometerPlayActivity.this, "image", "jpg");
                BitmapDrawable ob = new BitmapDrawable(getResources(), saved);
                mSimulationView.setBackgroundDrawable(ob);
            }
        }, 3000);


//        if (AppHelper.isSystemAlertPermissionGranted(this) || AppHelper.requestSystemAlertPermission(this)) {
...
//        }
    ...
    class SimulationView extends FrameLayout implements SensorEventListener {
        ...
        private static final float sBallDiameter = 0.020f;
